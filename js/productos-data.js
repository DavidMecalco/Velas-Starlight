...
const productosData = [
    {
        ...
        characteristics: [
            { icon: "fas fa-leaf", title: "Cera Natural", description: "Elaborada con cera de alta calidad", color: "text-green-500" },
            { icon: "fas fa-hand-sparkles", title: "Artesanal", description: "Hecha a mano con dedicación", color: "text-blue-500" },
            { icon: "fas fa-home", title: "Ambientador", description: "Ideal para crear atmósferas", color: "text-purple-500" }
        ],
        care: [
            { icon: "fas fa-exclamation-triangle", title: "Supervisión", description: "Nunca dejar encendida sin supervisión", color: "text-yellow-500" },
            { icon: "fas fa-scissors", title: "Mecha", description: "Recortar mecha a 5mm antes de encender", color: "text-gray-500" },
            { icon: "fas fa-clock", title: "Tiempo", description: "Encender máximo 4 horas continuas", color: "text-blue-500" }
        ],
        featured: false,
        new: false,
        available: true
    },
    {
        ...
        characteristics: [
            { icon: "fas fa-heart", title: "Serenidad", description: "Diseño angelical que transmite paz", color: "text-pink-500" },
            { icon: "fas fa-leaf", title: "Cera Premium", description: "Soya y parafina de alta calidad", color: "text-green-500" },
            { icon: "fas fa-star", title: "Artesanal", description: "Elaborada con dedicación y amor", color: "text-yellow-500" }
        ],
        care: [
            { icon: "fas fa-exclamation-triangle", title: "Supervisión", description: "Nunca dejar encendida sin supervisión", color: "text-yellow-500" },
            { icon: "fas fa-scissors", title: "Mecha", description: "Recortar mecha a 5mm antes de encender", color: "text-gray-500" },
            { icon: "fas fa-shield-alt", title: "Superficie", description: "Colocar sobre superficie resistente al calor", color: "text-blue-500" }
        ],
        featured: false,
        new: false,
        available: true
    ...
    },
    {
        ...
        characteristics: [
            { icon: "fas fa-droplet", title: "Hidratación Profunda", description: "Ácido hialurónico al 5%", color: "text-blue-500" },
            { icon: "fas fa-leaf", title: "Ingredientes Naturales", description: "Fórmula libre de químicos agresivos", color: "text-green-500" },
            { icon: "fas fa-gem", title: "Absorción Rápida", description: "Textura ligera que se absorbe al instante", color: "text-purple-500" },
            { icon: "fas fa-star", title: "Anti-edad", description: "Reduce líneas de expresión", color: "text-yellow-500" }
        ],
        care: [
            { icon: "fas fa-hand-paper", title: "Aplicación", description: "Aplicar sobre piel limpia y seca", color: "text-blue-500" },
            { icon: "fas fa-eye", title: "Evitar Ojos", description: "No aplicar directamente en el contorno de ojos", color: "text-yellow-500" },
            { icon: "fas fa-thermometer-half", title: "Conservación", description: "Mantener en lugar fresco y seco", color: "text-red-500" },
            { icon: "fas fa-calendar", title: "Caducidad", description: "Usar dentro de 12 meses tras abrir", color: "text-green-500" }
        ],
        featured: true,
        new: true,
        available: true
